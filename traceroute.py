...
def main():
    ...
    # USA Website
    # icmpHelperPing.sendPing("www.amazon.com") 
    
    # China Webiste
    # icmpHelperPing.sendPing("www.baidu.com") 

    # Brazil Webiste
    # icmpHelperPing.sendPing("www.google.com.br") 

    # Germany Website
    icmpHelperPing.sendPing("Google.de") 
    ...
    # Brazil Website
    # icmpHelperPing.traceRoute("www.google.com.br")

    # Germany Website 
    icmpHelperPing.traceRoute("Google.de")
